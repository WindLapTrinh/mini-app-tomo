...
const BottomNavigationComponent = ({
  ...
  const [activeTab, setActiveTab] = useState(keyTab || "chat");
    ...
    const fetchCounts = async () => {
      try {
        const responses = await Promise.all([
          axios.get(`https://ileader.cloud/api/MiniApp/CountNotSeenEvent?guidStudent=${studentGuid}`),
          axios.get(`https://ileader.cloud/api/MiniApp/CountNotSeenAccounting?guidStudent=${studentGuid}`),
          axios.get(`https://ileader.cloud/api/MiniApp/CountNotSeenEducation?guidStudent=${studentGuid}`),
          axios.get(`https://ileader.cloud/api/MiniApp/CountNotSeenSchedule?guidStudent=${studentGuid}`),
          axios.get(`https://ileader.cloud/api/MiniApp/CountNotSeenTranscript?guidStudent=${studentGuid}`),
          axios.get(`https://ileader.cloud/api/MiniApp/CountNotSeenAttendance?guidStudent=${studentGuid}`),
          axios.get(`https://ileader.cloud/api/MiniApp/CountNotSeenTuition?guidStudent=${studentGuid}`),
          axios.get(`https://ileader.cloud/api/MiniApp/CountNotSeenRegister?guidStudent=${studentGuid}`)
        ]);
  ...
  const handleNavigation = (path, keyTab) => {
    navigate(path, { state: { studentGuid, keyTab } });
    setActiveTab(keyTab);
  };
  ...
  const handleSelectDate = (path, keyTab) =>{
    ...
    setActiveTab(keyTab);
    navigate(path, { state: { studentGuid, studentName, phoneNumber, keyTab, currentDate: newCurrentDate } });
  }
          ...
          [
            {
              ...
              onClick: () => {handleSelectDate("/timetable","education")},
            },
            {
              text: (
                <div className="accounting-icon-wrapper">
              ...
              onClick: () => {handleSelectDate("/transcript","education")}
            },
            {
              text: (
                <div className="accounting-icon-wrapper">
              ...
              onClick: () => {handleSelectDate("/rollcall", "education")},
            },
            {
              text: (
                <div className="accounting-icon-wrapper">
            ...
            },
            {
              text: (
                <div className="accounting-icon-wrapper">
                  <span className="title-header-sheet">Khảo sát đánh giá</span>
                </div>
              ),
              onClick: () => {handleSelectDate("/survey", "education")},
            },
          ],
          ...
          [
            {
              ...
              onClick: () => {handleSelectDate("/tuitionFees","accountant")},
            },
            {
              text: (
                <div className="accounting-icon-wrapper">
              ...
              onClick: () => {handleSelectDate("/register", "accountant")},
            },
          ],
          [{ text: "Thoát", close: true }],
        ]}
