...
// Create Context for Address Data
...
const AddressPage = () => {
  ...
  const handleSubmitAddress = () => {
    ...
    console.log("Address user add: ", newAddress);
    AddressContext(newAddress); // Correct usage of hook function
    navigate("/listAddress", {state : address});
  };
  ...
  return (
    <Box className="address-page" p={4}>
      ...
      <Box className="address-info" mb={4}>
        ...
        <Select
          placeholder={selectedCity ? getCityNameById(selectedCity) : "Chọn tỉnh/ thành phố"}
          size="large"
        ...
        <Select
          placeholder={selectedDistrict ? getDistrictNameById(selectedDistrict) : "Chọn quận/huyện"}
          size="large"
        ...
        <Select
          placeholder={selectedWard ? getWardNameById(selectedWard) : "Chọn phường/xã/thị trấn"}
          size="large"
